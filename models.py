...
class Game(Base):
    ...
    blue_p1_id = Column(INTEGER, ForeignKey("players.id"), nullable=False)
    blue_p2_id = Column(INTEGER, ForeignKey("players.id"), nullable=False)
    blue_points = Column(INTEGER, nullable=False)
    red_p1_id = Column(INTEGER, ForeignKey("players.id"), nullable=False)
    red_p2_id = Column(INTEGER, ForeignKey("players.id"), nullable=False)
